...
<cite>
**本文档中引用的文件**  
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj)
- [FodyWeavers.xml](file://PdfEditor/FodyWeavers.xml)
- [Config.cs](file://PdfEditor/Config.cs)
- [MainForm.cs](file://PdfEditor/MainForm.cs)
- [MyTools.sln](file://MyTools.sln)
- [packages.config](file://PdfEditor/packages.config)
- [PdfHelperLibrary.csproj](file://PdfHelperLibrary/PdfHelperLibrary.csproj)
- [App.config](file://PdfEditor/App.config)
</cite>
...
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L1-L140)
...
- `PdfEditor.csproj`: `<TargetFrameworkVersion>v4.7.2</TargetFrameworkVersion>`
...
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L12)
...
构建成功后，可执行文件将位于 `PdfEditor\bin\Debug\` 或 `PdfEditor\bin\Release\` 目录下。

**Section sources**
- [packages.config](file://PdfEditor/packages.config#L1-L5)
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L3-L4)
- [MyTools.sln](file://MyTools.sln#L1-L212)
...
**Section sources**
- [Config.cs](file://PdfEditor/Config.cs#L1-L9)
- [MainForm.cs](file://PdfEditor/MainForm.cs#L78-L194)
- [Settings.Designer.cs](file://PdfEditor/Properties/Settings.Designer.cs#L1-L30)
...
**Section sources**
- [FodyWeavers.xml](file://PdfEditor/FodyWeavers.xml#L1-L3)
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L3-L4)
- [packages.config](file://PdfEditor/packages.config#L3-L4)
...
**Section sources**
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L197-L203)
...
**Section sources**
- [MainForm.cs](file://PdfEditor/MainForm.cs#L1-L194)
- [PdfEditor.csproj](file://PdfEditor/PdfEditor.csproj#L1-L140)
- [MyTools.sln](file://MyTools.sln#L1-L212)