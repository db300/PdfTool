    ...
    public partial class MainForm : Form
    {
        ...
        private void InitUi()
        {
            ...
            tabControl.TabPages.AddRange(new TabPage[]
            {
                ...
                new TabPage("编码转换") { BorderStyle = BorderStyle.None, Name = "tpTextEncodingConverter" },
            ...
            tabControl.TabPages["tpTextEncodingConverter"].Controls.Add(new TextEncodingConverter { Dock = DockStyle.Fill });
